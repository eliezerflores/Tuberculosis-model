...
%Optimized:
k2=2.176e-10; % fagocitosis
k4=40; %muerte de Tf por Mf
k5=1.4857; % apoptosis
k6=1000; % reclutamiento de M por Mf
k9=7.1981e-11; % muerte de M por T
k10=0.05; % muerte de Mf por T
k13=4; % necrosis
k14=134.57; % muerte de Mf por Tf
...
Mtot_exp=[NaN, 471915.58]; % cel/pulmón
Ttot_exp=[2.4e7, NaN]; % UFC/pulmón
%% Plot the data
figure(1)
hold on
subplot(1,2,1)
...
tspan = [27 time_E(end)]; %integration interval
...
y01=6.333001535743553e+05;%Macrofago
y02=0.019976728050907;%Macrofago que fagocito
y03=2.347018703753096e+07;%Tuberculosis libre
y04=77.418596989053060;%Tuberculosis fagocitada
