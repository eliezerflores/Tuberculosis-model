...
%Please see "bifurcations_Ph1" and "bifurcations_Ph2" for indications. 
%The logic is the same, some parameter values are changed here becuase 
%they adapt between phases.
...
%Here you can see the parameter threshold values comented (in spanish), you
%can also look for them on the matrices files as in previous phases.
