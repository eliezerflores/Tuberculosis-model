...
matrizF2K= NaN(500,20);

for i = 1:500
  
  k2=unifrnd(0.1*5.8e-08,10*5.8e-08);
  k4=unifrnd(0.1*80000,10*80000);
  k5=unifrnd(0.1*290.8121,10*290.8121);
  k6=unifrnd(0.1*7141000,10*7141000);
  k9=unifrnd(0.1*4.8916e-10,10*4.8916e-10);
  k10=unifrnd(0.1*0.2638,10*0.2638);
  k13=unifrnd(0.1*3.8989e-02,10*3.8989e-02);
  k14=unifrnd(0.1*444.427,10*444.427);
...
matrizF2K(i,14)=k16;
matrizF2K(i,15)=k17;
matrizF2K(i,16)=counter_stable_positive_real_solution;
matrizF2K(i,17)=Mtot(1);
matrizF2K(i,18)=Ttot(1);
if counter_stable_positive_real_solution>1
matrizF2K(i,19)=Mtot(2);
matrizF2K(i,20)=Ttot(2);
end
