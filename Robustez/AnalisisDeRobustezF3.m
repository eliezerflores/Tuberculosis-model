...
for i = 1:500
  ...
  k15=unifrnd(0.1*2.4e+07,10*2.4e+07);
...
matrizF3(i,14)=k16;
matrizF3(i,15)=k17;
matrizF3(i,16)=counter_stable_positive_real_solution;
matrizF3(i,17)=Mtot(1);
matrizF3(i,18)=Ttot(1);
if counter_stable_positive_real_solution>1
matrizF3(i,19)=Mtot(2);
matrizF3(i,20)=Ttot(2);
end
